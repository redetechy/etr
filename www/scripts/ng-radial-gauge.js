     ...
     return {
         ...
         link: function (scope, ele, attrs) {
             ...
             */
             ...
             var outerRadius = Math.round((view.width * 150) / 300);
			 ...
			 //console.log("attrs.majorgraduationtextsize is " + attrs.majorgraduationtextsize);
             var majorGraduationTextSize = parseInt(attrs.majorgraduationtextsize);
			 //console.log("majorGraduationTextSize is " + majorGraduationTextSize);
             ...
             var renderGraduationNeedle = function (value, valueUnit, precision, minLimit, maxLimit) {
                 ...
                 if (typeof value === 'undefined') {
                     ...
                     var lineData = [
                         ...
                         //var pointerLine = d3.svg.line().curve(d3.curveMonotoneX);
